//this is Incremental static regeneration page
...
export default async function DynamicPage() {
  ...
  return (
    ...
    >
      ...
      >
        This image below is fetched and cached in server for certain time
        {"(i.e) the value assigned to revalidate"} and then on request after
        that specified time the api is called and new image is requested,
